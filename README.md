<div align="center">
<img width="500" height="275" alt="GHBanner" src="images.png" />
</div>
...
An intuitive, multi-step form allows students to add detailed information about their projects. Students can also edit or delete their own submissions (simulated via a registration number for this demo).
...
- It uses a Gemini model with a carefully crafted prompt, instructing it to act as an expert engineering professor. The AI evaluates projects based on innovation, technical complexity, potential impact, and clarity.
