...
const Header: React.FC<HeaderProps> = ({ onAddProjectClick, searchTerm, onSearchChange, theme, setTheme }) => {
  return (
    <header className="bg-white dark:bg-gray-800 shadow-md dark:shadow-none sticky top-0 z-30 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between h-20 gap-4">
          <div className="flex items-center space-x-4 flex-shrink-0">
            <img 
              ...
              className="h-14"
            />
            <span className="hidden lg:block text-xl font-bold text-gray-800 dark:text-gray-100">Jeppiaar Institute of Technology</span>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <button
                ...
                className="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-[#192F59] rounded-lg shadow-md hover:bg-[#101f3c] focus:outline-none focus:ring-2 focus:ring-[#192F59] focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-all duration-200 flex-shrink-0"
            >
              <PlusCircle size={20} />
